'''
This flask app implements a basic blockchain that can:
- add transactions to the blockchain and mine
- view transactions
...
class Blockchain:
    ...
    def valid_proof(self, transactions, last_hash, nonce, difficulty=MINING_DIFFICULTY):
        ...
        return guess_hash[:difficulty] == '0'*difficulty  # checks if the guess_hash begins with as many number of zeroes as the difficulty 
    ...
    def valid_chain(self, chain):
        ...
        """
        last_block = chain[0]  # initialising the last block variable witht genesis block
        current_index = 1
        ...
        while current_index < len(chain):
            ...
            transactions = block['transactions'][:-1]  # Delete the reward transaction
            # Need to make sure that the dictionary is ordered. Otherwise we'll get a different hash
            transaction_elements = ['sender_address', 'recipient_address', 'value']
            # converting transactions list into list of ordered dict transactions
        ...
        return True  # returns True if all the blocks are valid
