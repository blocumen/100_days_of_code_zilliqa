...
def main():
  ...
  print (p1.doublePoint().x)
  print (p1.doublePoint().y)
  p2 = p1.doublePoint()
  p3 = p2.sum(p1)
  ...
  #print "3*p1"
  print (p1.multiplyPointByScalar(3).x)
  print (p1.multiplyPointByScalar(3).y)
  ...
  #print "4*p1"
  print (p1.multiplyPointByScalar(4).x)
  print (p1.multiplyPointByScalar(4).y)

  #print "5*p1"
  print (p1.multiplyPointByScalar(5).x)
  print (p1.multiplyPointByScalar(5).y)

  #print "6*p1"
  print (p1.multiplyPointByScalar(6).x)
  print (p1.multiplyPointByScalar(6).y)

  #print "7*p1"
  print (p1.multiplyPointByScalar(7).x)
  print (p1.multiplyPointByScalar(7).y)
