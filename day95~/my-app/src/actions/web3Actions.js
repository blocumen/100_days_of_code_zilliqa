...
import { WEB3_ACCOUNT_CHANGE, WEB3_CONNECTED, WEB3_ERROR } from './types'

var ImageRegisterContractArtifact = 0
export const web3Connect = () => async (dispatch, getState) => {
    try {
        ...
        const errorMessage = `Error loading 'ImageRegister' contract. Be sure MetaMask is connected to a network and the contract is deployed. ERR: ${error.message
            }`
